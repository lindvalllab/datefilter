...
def test_include_row_true() -> None:
    ...
    assert include_row(row, parsed_filter)
...
def test_include_row_false() -> None:
    ...
    assert not include_row(row, parsed_filter)
...
def test_include_row_negative_before() -> None:
    ...
    assert not include_row(too_early_row, parsed_filter)
    assert not include_row(too_late_row, parsed_filter)
    assert include_row(included_row, parsed_filter)
