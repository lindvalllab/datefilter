...
def test_include_row_true() -> None:
    ...
    assert include_row(row, parsed_filter, False)
...
def test_include_row_false() -> None:
    ...
    assert not include_row(row, parsed_filter, False)
...
def test_include_row_negative_before() -> None:
    ...
    assert not include_row(too_early_row, parsed_filter, False)
    assert not include_row(too_late_row, parsed_filter, False)
    assert include_row(included_row, parsed_filter, False)
